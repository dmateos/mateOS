...
- **Test after every change.** Run the 33-test suite (`test` in the shell). If you added a feature, add a test. If you fixed a bug, add a regression test.
...
2. `make run` → shell boots → type `test` → all 33 tests pass
